...
{
    public class AddAgilityBuff: Engines.Spells.SpellBuff
    {
        public int Value = 0;

        public AddAgilityBuff(int value, int duration, Fights.Fighter fighter)
        ...
        {
            BuffedFighter.Stats.Agility.Bonus += Value;
        }
